...
public class BannerViewTest {
    ...
    public void testFindBestBannerSize() {
        ...
        ad.putInt(Ad.WIDTH, 480);
        ad.putInt(Ad.HEIGHT, 480);
        banners.add(ad);

        ad = new Bundle();
        ad.putInt(Ad.WIDTH, 120);
        ad.putInt(Ad.HEIGHT, 60);
        banners.add(ad);

        ad = new Bundle();
        ad.putInt(Ad.WIDTH, 300);
        ad.putInt(Ad.HEIGHT, 600);
        banners.add(ad);

        ad = new Bundle();
        ad.putInt(Ad.WIDTH, 728);
        ad.putInt(Ad.HEIGHT, 90);
        banners.add(ad);

        ad = new Bundle();
        ad.putInt(Ad.WIDTH, 970);
        ad.putInt(Ad.HEIGHT, 100);
        banners.add(ad);

        ad = new Bundle();
        ad.putInt(Ad.WIDTH, 300);
        ad.putInt(Ad.HEIGHT, 250);
        banners.add(ad);

        ad = new Bundle();
        ad.putInt(Ad.WIDTH, 88);
        ad.putInt(Ad.HEIGHT, 31);
        banners.add(ad);
